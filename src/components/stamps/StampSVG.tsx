...
export const STAMP_CONFIGS: Record<StampId, StampConfig> = {
  ...
  assessment:  { id: 'assessment',  label: 'Assessment and Feedback', short: 'Assessment and Feedback', bg: '#7A5C14', fg: '#FFF3CC', denom: '40¢' },
...
/** Sun with check — Assessment and Feedback */
